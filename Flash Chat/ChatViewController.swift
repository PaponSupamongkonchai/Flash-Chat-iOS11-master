...
class ChatViewController: UIViewController ,UITableViewDelegate, UITableViewDataSource ,UITextFieldDelegate{
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        let massageDictionary = ["Sender":Auth.auth().currentUser?.email,"MessageBody":messageTextfield.text!]
        
        messageDB.childByAutoId().setValue(massageDictionary){
            (error,reference) in
    ...
    @IBAction func logOutPressed(_ sender: AnyObject) {
        ...
        do{
            ...
            print("erre, there was a problem signing out.")
        }
